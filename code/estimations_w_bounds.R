...
#   df_lower_bound_actual[[var]] <- replace_na_with_min(df_lower_bound_actual[[var]])
# }
# 
...
# for (var in all.dv.names.t1) {
#   df_upper_bound_actual[[var]] <- replace_na_with_max(df_upper_bound_actual[[var]])
# }
# 
# for (var in trans.law.dvs.t1) {
#   df_upper_bound_actual[[var]] <- replace_na_with_max(df_upper_bound_actual[[var]])
...
dataset_list <- list(
  ...
  #df_upper_bound_actual = df_upper_bound_actual, 
  df_lower_bound = df_lower_bound
  #df_lower_bound_actual = df_lower_bound_actual
)
